 ...
 * and then in the finally block,cleanUp() throws an exception, that second exception will be thrown and the first
 * exception will be lost forever. If the code that you call in a finally block can possibly throw an exception, make
 * sure that you either handle it, or log it. Never let it bubble out of the finally block. For the correct using :
 * {@link HandleFinally}
 * 
 * @author seruhatto
 *
