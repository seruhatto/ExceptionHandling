 ...
 * 
 * Although not always incorrect, this is usually wrong. Instead of returning null, throw the exception, and let the
 * caller deal with it. You should only return null in a normal (non-exceptional) use case (e.g., "This method returns
...
public class ExceptionSwallow {
	...
	public static void main(String[] args) {
		...
		if (responseCode == null) {
			logger.error("Message has not been sent, There is a network problem.");
		} else {
